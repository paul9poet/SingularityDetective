...
✔ **Pedagogic material** — teaching core concepts (e.g., topology, spectral invariants)  
✔ **Exploratory dashboards** — running experiments, visualizing model decision traces  
✔ **Collaborative artifacts** — enabling contributors to extend and share insights

This guide introduces you to the role of notebooks in this repository, how to use them, and how to contribute.

---

## 📦 Why Use Jupyter Notebooks Here?
